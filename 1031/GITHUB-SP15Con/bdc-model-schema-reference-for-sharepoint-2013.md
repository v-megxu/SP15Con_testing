...
|**Name** <br/> |Erforderlich <br/> Der Name für den **TypeDescriptor**. <br/> Attributtyp: **String** <br/> **HINWEIS** <br/> Der Name für einen **TypeDescriptor** sollte nicht die Sonderzeichen "/" (Schrägstrich), "." (Punkt) oder "[" (öffnende eckige Klammer) enthalten.          |
